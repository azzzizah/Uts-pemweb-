...
<header class="bg-dark py-5">
      <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
          <h1 class="display-4 fw-bolder">Godrive Rentals</h1>
                ...
                <div class="text-center">
                  ...
                  <ul class="list-unstyled list-style-group">
                    ...
                    >
                      ...
                      <span style="font-weight: 600">Pertalite</span>
                    </li>
                    <li
                      class="border-bottom p-2 d-flex justify-content-between"
                    >
          ...
          <div class="col mb-5">
            <div class="card h-100">
              ...
              <div class="card-body card-body-custom pt-4">
                <div class="text-center">
                  <!-- Product name-->
                  <h5 class="fw-bolder">Daihatsu Terios</h5>
                  <!-- Product price-->
                  <div class="rent-price mb-3">
                    <span class="text-primary">Rp.300.000/</span>day
                  </div>
                  <ul class="list-unstyled list-style-group">
                    <li
                      class="border-bottom p-2 d-flex justify-content-between"
                    >
                      <span>Bahan bakar</span>
                      <span style="font-weight: 600">Pertamax</span>
                    </li>
                    <li
                      class="border-bottom p-2 d-flex justify-content-between"
                    >
          ...
          <div class="col mb-5">
            <div class="card h-100">
              ...
              <div class="card-body card-body-custom pt-4">
                <div class="text-center">
                  <!-- Product name-->
                  <h5 class="fw-bolder">Toyota Avanza</h5>
                  <!-- Product price-->
                  <div class="rent-price mb-3">
